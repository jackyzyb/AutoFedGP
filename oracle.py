...
def update_global(args, local_models_dict, old_global_model_dict, finetune_global_model_dict, cos_sim, clients_size, clients_size_frac, cur_epoch):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_lr', type=float, default=0.003)
    ...
    for net_id in range(args.n_parties): # 0-9
        ...
        if net_id < args.n_parties - 1:
            ...
            # # noise_level = 0
            # train_dl, test_dl, _, _ = get_dataloader(args.dataset, args.datadir, args.source_batch_size, 32, dataidxs, noise_level)
            ...
            if args.neg:
                ...
                server_dls['train'].append(unlabeled_dl)
                server_dls['test'].append(perturb_dl)
