...
if __name__ == '__main__':
    ...
    X_train, y_train, X_test, y_test, net_dataidx_map, traindata_cls_counts = partition_data(
        args.dataset, args.datadir, args.logdir, args.partition, args.n_parties - 1, beta=args.beta)
    ...
    noise_levels = [0.3 - args.noise/2, 0.3, 0.3 + args.noise/2]
    source_noises = [noise_levels[0]] * 3 + [noise_levels[1]] * 3 + [noise_levels[2]] * 3
    # print(source_noises)
    for net_id in range(args.n_parties): # 0-8
